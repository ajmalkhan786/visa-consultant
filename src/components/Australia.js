    ...
    <Layout>
      <Box sx={{position: 'relative'}}>
        <Box className='top-img'>
            <img src='/images/australia.jpg' alt='about' className='service' />
        </Box>
      ...
      <Container sx={{py: 4}}>
        ...
        <Typography className='h3 fwn'>
          <AnimatedOnScroll animationIn="fadeInRight" className='animation'>
            Studying in Australia is a great way to experience the unique Aussie lifestyle while gaining great new skills. Australia has world class universities, practical vocational colleges and outstanding English language schools to support international students. <br></br>
            Right Choice Overseas Consultancy is a specialized agency of education in Australia. We have strong relationships with many Australian Institutes. We are here to provide a free support regardless of which study program you are interested in. We will guide you through the complex process of obtaining a Student Visa in Australia, from the choice of a school to the enrolment.
          </AnimatedOnScroll>
        </Typography>
        <Grid container spacing={2} sx={{ pt: 4}}>
          <Grid item md={4} sm={6} xs={12} sx={{pl: 0}}>
            <Box sx={{boxShadow: '1px 1px 10px 1px #888888', p: 3, backgroundColor: '#fff'}}>
              <Container sx={{backgroundColor: '#ff6b06', color: '#fff', py: 1, borderRadius: '10px'}}>
                <Typography className='h2 fwb'>Why Study In Australia</Typography>
              </Container>
          ...
          <Grid item md={4} sm={6} xs={12} sx={{pl: 0}}>
            <Box sx={{boxShadow: '1px 1px 10px 1px #888888', p: 3, backgroundColor: '#fff'}}>
              <Container sx={{backgroundColor: '#ff6b06', color: '#fff', py: 1, borderRadius: '10px'}}>
                <Typography className='h2 fwb'>Top Australian</Typography>
              </Container>
              <Container className='padding'>
                <List>
                  <AnimatedOnScroll animationIn="fadeInLeft" className='animation'>
